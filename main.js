...
function baileyBio() {
  ...
  <li> <span>GitHub URL: </span> <a href=${userInfo.html_url}> Bailey's Github</a> </li>
  <li> <span>Email: </span> ${userInfo.email}</li>
  <li> <span>Company: </span> ${userInfo.company} </li>
  <li> <span> Website: </span><a href=${userInfo.blog}>Company Site</a> </li>
  `;
